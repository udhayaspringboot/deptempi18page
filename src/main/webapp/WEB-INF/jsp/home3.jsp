...
<body>
	...
	<div class="container6">
		<div id="header">
			...
			<ul>
			<c:if test="${loggedInUser eq 'admin'}">
			<li>	<a href="homeserv"><font color="white"><spring:message code="lable.admin" /></font></a></li>
			</c:if>
			<c:if test="${loggedInUser eq 'hr'}">
			<li><a href="homeserv"><font color="white"><spring:message code="lable.home" /></font></a>
...
<spring:message code="lable.admess" />
 ...
 <form:form action="deledept" method="get" modelAttribute="deptpage">
						...
						<table class="d" border="1px solid black" align="center">
							...
							<form:form action="updatedept/${dval.deptId}" method="get" modelAttribute="deptpage">
								...
								<c:if test="${deptva ne dval.deptId}">
									...
									<td><input type="checkbox" name="ids" value="${dval.deptId}"></td>
									</tr>
								</c:if>
							</c:forEach>
    ...
    <c:if test="${page > 1}">
        <a href="<c:out value="${prev}" />" class="pn prev">Prev</a>..0
    </c:if>
